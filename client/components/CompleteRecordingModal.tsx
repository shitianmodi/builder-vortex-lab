        ...
        <div className="flex flex-col gap-4">
          ...
          >
            ...
            <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${
              selectedOption === 'direct' ? 'border-[#004DA9]' : 'border-[#B6C2DA]'
            }`}>
              {selectedOption === 'direct' && <div className="w-3 h-3 bg-[#004DA9] rounded-full"></div>}
            </div>
          </div>
