...
export default function EditWaterEntry({ isOpen, onClose, onSave, initialData }: EditWaterEntryProps) {
          ...
          <div className="flex flex-col items-center gap-3">
            <div className="relative w-full h-[214px] rounded-2xl overflow-hidden">
              ...
              <div className="absolute top-3 right-3 flex gap-3">
                ...
                <button className="w-10 h-10 bg-black bg-opacity-30 rounded-full flex items-center justify-center">
                  <svg width="28" height="28" viewBox="0 0 28 28" fill="none">
                    <path d="M4.56367 18.0838C4.84557 18.084 5.11634 18.1961 5.31568 18.3954C5.51498 18.5949 5.62735 18.8655 5.62735 19.1475V22.3727H8.85255C9.13453 22.3727 9.40509 22.485 9.60456 22.6843C9.8039 22.8837 9.91604 23.1544 9.91622 23.4363C9.91622 23.7183 9.80385 23.9889 9.60456 24.1883C9.40506 24.3878 9.13469 24.5 8.85255 24.5H4.56367C4.28153 24.5 4.01116 24.3878 3.81166 24.1883C3.61216 23.9888 3.5 23.7185 3.5 23.4363V19.1475C3.5 18.8653 3.61216 18.5949 3.81166 18.3954C4.01113 18.1961 4.28169 18.0838 4.56367 18.0838Z" fill="white"/>
                    <path d="M23.4363 18.0838C23.7183 18.0838 23.9889 18.1961 24.1883 18.3954C24.3878 18.5949 24.5 18.8653 24.5 19.1475V23.4363C24.5 23.7185 24.3878 23.9888 24.1883 24.1883C23.9888 24.3878 23.7185 24.5 23.4363 24.5H19.1475C18.8653 24.5 18.5949 24.3878 18.3954 24.1883C18.1961 23.9889 18.0838 23.7183 18.0838 23.4363C18.084 23.1544 18.1961 22.8837 18.3954 22.6843C18.5949 22.485 18.8655 22.3727 19.1475 22.3727H22.3727V19.1475C22.3727 18.8655 22.485 18.5949 22.6843 18.3954C22.8837 18.1961 23.1544 18.084 23.4363 18.0838Z" fill="white"/>
                    <path fillRule="evenodd" clipRule="evenodd" d="M19.1475 7.78887C19.4296 7.78887 19.7 7.90103 19.8995 8.10054C20.099 8.30004 20.2111 8.57041 20.2111 8.85255V19.1475C20.2111 19.4296 20.099 19.7 19.8995 19.8995C19.7 20.099 19.4296 20.2111 19.1475 20.2111H8.85255C8.57041 20.2111 8.30004 20.099 8.10054 19.8995C7.90103 19.7 7.78887 19.4296 7.78887 19.1475V8.85255C7.78887 8.57041 7.90103 8.30004 8.10054 8.10054C8.30004 7.90103 8.57041 7.78887 8.85255 7.78887H19.1475ZM9.91622 18.0838H18.0838V9.91622H9.91622V18.0838Z" fill="white"/>
                    <path d="M8.85255 3.5C9.13469 3.5 9.40506 3.61216 9.60456 3.81166C9.80385 4.01113 9.91622 4.28169 9.91622 4.56367C9.91604 4.84557 9.8039 5.11634 9.60456 5.31568C9.40509 5.51498 9.13453 5.62735 8.85255 5.62735H5.62735V8.85255C5.62735 9.13453 5.51498 9.40509 5.31568 9.60456C5.11634 9.8039 4.84557 9.91604 4.56367 9.91622C4.28169 9.91622 4.01113 9.80385 3.81166 9.60456C3.61216 9.40506 3.5 9.13469 3.5 8.85255V4.56367C3.5 4.28153 3.61216 4.01116 3.81166 3.81166C4.01116 3.61216 4.28153 3.5 4.56367 3.5H8.85255Z" fill="white"/>
                    <path d="M23.4363 3.5C23.7185 3.5 23.9888 3.61216 24.1883 3.81166C24.3878 4.01116 24.5 4.28153 24.5 4.56367V8.85255C24.5 9.13469 24.3878 9.40506 24.1883 9.60456C23.9889 9.80385 23.7183 9.91622 23.4363 9.91622C23.1544 9.91604 22.8837 9.8039 22.6843 9.60456C22.485 9.40509 22.3727 9.13453 22.3727 8.85255V5.62735H19.1475C18.8655 5.62735 18.5949 5.51498 18.3954 5.31568C18.1961 5.11634 18.084 4.84557 18.0838 4.56367C18.0838 4.28169 18.1961 4.01113 18.3954 3.81166C18.5949 3.61216 18.8653 3.5 19.1475 3.5H23.4363Z" fill="white"/>
                  </svg>
                </button>
              </div>

              {/* Selection Rectangle */}
              <svg className="absolute bottom-4 right-16" width="85" height="94" viewBox="0 0 85 94" fill="none">
                <rect x="2.5" y="2" width="80" height="90" stroke="#0D802C" strokeWidth="2"/>
            ...
            <div className="text-[#7E90B0] text-sm text-center">拖拽移动或缩放识别框</div>
          </div>
          ...
          <div className="flex items-center gap-8">
            ...
            <div className="flex-1 bg-[#F4F4F5] rounded-lg p-3 flex justify-between items-center">
              ...
              <svg width="16" height="16" viewBox="0 0 16 17" fill="none">
                <path fillRule="evenodd" clipRule="evenodd" d="M13.6011 5.39906C13.2692 5.06711 12.731 5.06711 12.3991 5.39906L8.0001 9.79802L3.60114 5.39906C3.26919 5.06711 2.731 5.06711 2.39906 5.39906C2.06711 5.731 2.06711 6.26919 2.39906 6.60114L7.39906 11.6011C7.731 11.9331 8.26919 11.9331 8.60114 11.6011L13.6011 6.60114C13.9331 6.26919 13.9331 5.731 13.6011 5.39906Z" fill="#3D526C"/>
              </svg>
            </div>
          </div>
        </div>
