...
const mockLogData: LogEntry[] = [
  ...
  },
  {
    ...
    type: "笔记",
    description:
      "笔记内容文本，笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容��本笔记内容文本笔记内容文本笔记内容文本笔记内容文本",
    noteContent: {
      ...
      <div className="flex w-full px-6 lg:px-14 py-6 lg:py-14 justify-between items-center min-h-[80px] lg:h-32">
        ...
        <div className="flex items-center gap-4 lg:gap-9">
          ...
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <button className="flex h-10 lg:h-12 px-3 lg:px-4 py-2 justify-center items-center gap-2 rounded-2xl bg-[#A8BDE8] cursor-not-allowed">
