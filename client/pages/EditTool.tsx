...
export default function EditTool({ tool }: EditToolProps) {
  ...
  const images = Array.from(
    ...
    (_, i) =>
      tool?.image ||
      "https://cdn.builder.io/api/v1/image/assets%2F633abf5e59cd4a2c979cb3a5ea2346f6%2F06b4710a09b04a72b9bbf1460daf50dc?format=webp&width=800",
  );
                ...
                <div
                  ...
                  className={`relative w-[140px] h-[140px] rounded-2xl overflow-hidden cursor-pointer ${
                    selectedImage === index + 1
                      ? "ring-2 ring-[#B6C2DA] ring-offset-2"
                      : ""
                  }`}
                ...
                >
                  ...
                  {index === 0 && (
                    <div className="absolute top-0 left-3">
                      <svg
                        className="w-5 h-6 fill-[#004DA9] stroke-white stroke-1"
                        viewBox="0 0 20 26"
                      >
                        <path
                          d="M19.5 -0.5V24.7695L18.7969 24.457L10 20.5469L1.20312 24.457L0.5 24.7695V-0.5H19.5Z"
                          fill="#004DA9"
                          stroke="white"
                        />
                      </svg>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-4">
              <button className="flex justify-center items-center gap-1 text-[#324459] hover:text-[#004DA9] transition-colors">
                <svg className="w-5 h-5" viewBox="0 0 20 20" fill="none">
                  <path
                    d="M15.8333 4.81445C15.8331 4.45678 15.5432 4.16686 15.1855 4.16667H4.81445C4.45678 4.16686 4.16686 4.45678 4.16667 4.81445V15.1855C4.16686 15.5432 4.45678 15.8331 4.81445 15.8333H15.1855C15.5432 15.8331 15.8331 15.5432 15.8333 15.1855V4.81445ZM17.5 15.1855C17.4998 16.4637 16.4637 17.4998 15.1855 17.5H4.81445C3.5363 17.4998 2.5002 16.4637 2.5 15.1855V4.81445C2.5002 3.5363 3.5363 2.5002 4.81445 2.5H15.1855C16.4637 2.5002 17.4998 3.5363 17.5 4.81445V15.1855Z"
                    fill="currentColor"
                  />
                  <path
                    d="M5.71484 3.35715C5.71484 2.88376 6.10229 2.5 6.58023 2.5C7.05817 2.5 7.44561 2.88376 7.44561 3.35715V8.69984L9.01976 7.76456L9.12568 7.71211C9.3784 7.60534 9.67024 7.62226 9.90993 7.76456L11.4841 8.69984V3.35715C11.4841 2.88376 11.8715 2.5 12.3495 2.5C12.8274 2.5 13.2148 2.88376 13.2148 3.35715V10.2144C13.2148 10.5232 13.0467 10.8078 12.7754 10.9599C12.5042 11.1119 12.1716 11.1085 11.9044 10.9499L9.46484 9.50007L7.02532 10.9499C6.75809 11.1085 6.42546 11.1119 6.1543 10.9599C5.88299 10.8078 5.71484 10.5232 5.71484 10.2144V3.35715Z"
                    fill="currentColor"
                  />
                </svg>
      ...
      {showExitModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="w-[400px] bg-white rounded-3xl p-8 flex flex-col items-center gap-6">
            <h2 className="text-[#3D526C] text-2xl font-semibold text-center">
              内容未保存
            </h2>
          ...
          <div className="w-[260px] bg-white rounded-3xl p-8 flex flex-col items-center gap-6">
            ...
            <div className="w-[120px] h-[120px] flex items-center justify-center">
              <svg className="w-24 h-24" viewBox="0 0 96 96" fill="none">
                <path
                  d="M48 0C74.5097 1.03082e-06 96 21.4903 96 48C96 74.5097 74.5097 96 48 96C21.4903 96 0 74.5097 0 48C0 21.4903 21.4903 0 48 0ZM76.0732 33.0469C73.8238 30.7975 70.1762 30.7975 67.9268 33.0469L42.2402 58.7334L28.3926 44.8867L28.1777 44.6826C25.9167 42.6399 22.4262 42.7078 20.2471 44.8867C18.068 47.0658 17.9991 50.5573 20.042 52.8184L20.2471 53.0332L35.9043 68.6895C39.4034 72.1886 45.0761 72.1885 48.5752 68.6895L76.0732 41.1934C78.3226 38.944 78.3225 35.2963 76.0732 33.0469Z"
                  fill="#0D802C"
                />
              </svg>
            </div>
