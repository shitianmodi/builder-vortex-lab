...
const colorData: ColorData[] = [
  { name: "红色", color: "#F55D5D", percentage: "100%", count: "99个", squares: 36 },
  { name: "蓝色", color: "#37A2E5", percentage: "100%", count: "99个", squares: 26 },
  { name: "绿色", color: "#58CA44", percentage: "100%", count: "99个", squares: 22 },
  { name: "黄色", color: "#FFDB0D", percentage: "100%", count: "99个", squares: 18 },
  { name: "紫色", color: "#BD6ECB", percentage: "100%", count: "99个", squares: 11 },
  { name: "橙色", color: "#FF8747", percentage: "100%", count: "99个", squares: 8 },
  { name: "灰色", color: "#A8ABB2", percentage: "100%", count: "99个", squares: 8 },
  { name: "多色", color: "linear-gradient(135deg, #FFA300 10.71%, #E20BBE 51.79%, #004DA9 92.86%)", percentage: "100%", count: "99个", squares: 5 }
];
...
export default function ReportDetail() {
  ...
  return (
    <div className="w-full min-h-screen bg-[#EEF1FA] flex flex-col px-14 py-14 gap-8">
      ...
      <div className="w-[1328px] bg-white rounded-3xl relative" style={{ height: '4053px' }}>
        ...
        <div className="absolute left-0 top-0 w-full h-[375px]">
          <div className="flex w-full max-w-[1232px] mx-auto justify-center items-end gap-16 px-12 pt-8 h-[241px]">
            ...
            <div className="flex-1 text-[#3D526C] text-base leading-8">
              心理沙盘游戏治疗，又称箱庭疗法或沙箱疗法，是一种以荣格心理学原理为基础，由多拉卡尔夫·发展创立的心理治疗方法。沙盘游戏是运用意象(积极想象)进行治疗��创造形式，沙盘中所表现的系列沙盘意象，营造 出沙盘游戏者心灵深处意识和无意识之间的持续性对话，以及由此而激发的治愈过程和人格(灵性与自性化的)发展。
              <br /><br />
        ...
        <div className="absolute left-12 top-[368px] w-[1232px] flex flex-col gap-16">
          ...
          <div className="w-[936px] flex flex-col gap-8">
            ...
            <div className="flex items-center gap-4 w-full">
              <h2 className="text-[#7E90B0] text-2xl font-semibold">基本信息</h2>
            ...
            <div className="flex items-center gap-24">
              ...
              <div className="w-[136px] flex flex-col gap-4">
                <div className="flex items-center gap-6">
                  <div className="w-8 text-[#7E90B0] text-base leading-7">姓名</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.name}</div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="w-8 text-[#7E90B0] text-base leading-7">性别</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.gender}</div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="w-8 text-[#7E90B0] text-base leading-7">班级</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.class}</div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="w-8 text-[#7E90B0] text-base leading-7">学号</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.studentId}</div>
                </div>
              </div>
              ...
              <div className="w-[230px] flex flex-col gap-4">
                <div className="flex items-center gap-6">
                  <div className="w-16 text-[#7E90B0] text-base leading-7">记录形式</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.recordType}</div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="text-[#7E90B0] text-base leading-7">开始时间</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.startTime}</div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="w-16 text-[#7E90B0] text-base leading-7">结束时间</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.endTime}</div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="w-16 text-[#7E90B0] text-base leading-7">总耗时</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.duration}</div>
                </div>
              </div>
              ...
              <div className="w-[184px] flex flex-col gap-4">
                <div className="flex items-center gap-6">
                  <div className="w-16 text-[#7E90B0] text-base leading-7">沙盘类型</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.sandboxType}</div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="w-16 text-[#7E90B0] text-base leading-7">模具总数</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.toolCount}</div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="text-[#7E90B0] text-base leading-7">第一个模具</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.firstTool}</div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="text-[#7E90B0] text-base leading-7">最后一个模具</div>
                  <div className="text-[#303133] text-base font-semibold">{mockReportData.lastTool}</div>
                </div>
              </div>
            </div>
            ...
            <div className="flex h-[342px] items-start gap-4 w-full">
              {mockReportData.images.map((image, index) => (
                <div key={index} className="flex-1 aspect-[148/83] rounded-2xl overflow-hidden relative">
                  <img
                    src={image}
                    alt={`沙盘成品${index + 1}`}
                    className="w-full h-full object-cover"
                    style={{ transform: `scale(1.1) translate(${index % 2 === 0 ? '-10%' : '-5%'}, -8%)` }}
                  />
                </div>
              ))}
            </div>
          ...
          <div className="w-[936px] flex flex-col gap-12">
            {/* Section Header */}
            <div className="flex items-center gap-4 w-full">
              <h2 className="text-[#7E90B0] text-2xl font-semibold">沙盘统计</h2>
              <div className="flex-1 h-[1px] bg-[#B6C2DA]"></div>
            </div>
              ...
              {mockCategoryData.map((category, index) => (
                <div key={index} className="flex-1 flex flex-col gap-3">
                  ...
                  <div className="h-[60px] px-4 flex justify-between items-center bg-[#EEF1FA] rounded-3xl">
                    <div className="text-[#7E90B0] text-lg font-semibold">{category.name}</div>
                    <div className="px-3 py-0.5 bg-[#004DA9] rounded-2xl">
                      <div className="text-white text-xl font-semibold">{category.total}</div>
                    </div>
                  </div>
                  ...
                  <div className="flex flex-col gap-1">
                    {category.items.map((item, itemIndex) => (
                      <div key={itemIndex} className="flex px-4 py-2 items-center gap-2">
                        <div className="text-[#3D526C] text-base leading-7">{item.name}</div>
                        <div className="flex-1 h-[1px] bg-[#E2E7F0]"></div>
                        <div className="text-[#004DA9] text-base font-semibold">{item.count}</div>
                      </div>
                    ))}
                  </div>
                </div>
            ...
            <div className="flex flex-col items-start gap-8 w-full">
              {colorData.map((color, index) => (
                <div key={index} className="flex px-3 justify-center items-start gap-6 w-full">
                  <div className="flex justify-between items-start flex-1">
                    <div className="flex w-14 items-center gap-2">
                      ...
                      />
                      <div className="text-[#7E90B0] text-base leading-7">{color.name}</div>
                    </div>
                    <div className="text-[#3D526C] text-base font-semibold">{color.percentage}</div>
                    <div className="text-[#3D526C] text-base font-semibold">{color.count}</div>
                  </div>
          ...
          <div className="w-[936px] flex flex-col gap-12">
            {/* Section Header */}
            <div className="flex items-center gap-4 w-full">
              <h2 className="text-[#7E90B0] text-2xl font-semibold">分析结果</h2>
              <div className="flex-1 h-[1px] bg-[#B6C2DA]"></div>
            </div>

            {/* Analysis Content */}
            <div className="flex flex-col justify-center items-end gap-4 w-full">
              <div className="text-[#324459] text-lg font-semibold w-full">沙具选择及象征</div>
              <div className="text-[#3D526C] text-base leading-8 w-full">
                来访在第一个沙具摆放之前大概用时XX分。在第X个和第X个沙具之间的时间较长，用时为X分。来访使用的沙具总数为  ，其中，XX种类占比做多。这可能代表了来访内心的想法、感受或者曾经的经历。来访在第一个沙具摆放之前大概用时XX分。在第X个和第X个沙具之间的时间较长，用时为X分。来访使用的沙具总数为  ，其中，XX种类占比做多。这可能代表了来访内心的想法、感受或者曾经的经历。
              </div>
              
              {/* Special Note */}
              <div className="w-[912px] px-6 py-4 flex flex-col items-start gap-2 border-l-[5px] border-[#CB2F2F] bg-[#F4F4F5]">
                <div className="text-[#CB2F2F] text-base font-semibold w-full">特��情况</div>
            ...
            <div className="flex flex-col items-start gap-4 w-full">
              <div className="text-[#324459] text-lg font-semibold w-full">整体布局分析</div>
              <div className="text-[#3D526C] text-base leading-8 w-full">
                沙具摆放的位置大都集中在XX/沙具均衡地分散在沙盘各处，占据了较大的面积/占据了较小的面积，这可能表示来访者内心世界丰富，有较多的想法、情感或经历需要表达。/这可能表明来访者内心相对封闭或保守，在某些方面缺乏自信或安全感，不愿意过多地展示自己的内心世界。<br />
            ...
            {/* Color Analysis */}
            <div className="flex flex-col items-start gap-4 w-full">
              <div className="text-[#324459] text-lg font-semibold w-full">色彩搭配分析</div>
              <div className="text-[#3D526C] text-base leading-8 w-full">
                沙具的选择以XX颜色巨多，这可能表示来访的人格特点是 ，对应的情绪特点是。
              </div>
            </div>

            {/* Self-awareness Analysis */}
            <div className="flex flex-col items-start gap-4 w-full">
              <div className="text-[#324459] text-lg font-semibold w-full">自我认知及安全感分析</div>
              <div className="text-[#3D526C] text-base leading-8 w-full">
        ...
        <div className="absolute right-[18px] top-[664px] w-24 flex flex-col gap-6">
          ...
          <div className="w-24 h-24 rounded-full bg-[#FFA300] flex items-center justify-center">
            <svg className="w-[54px] h-[54px]" viewBox="0 0 53 54" fill="none">
              <path d="M10.125 3.375C9.22989 3.375 8.37145 3.73058 7.73851 4.36351C7.10558 4.99645 6.75 5.85489 6.75 6.75V15.1875C6.75 16.5302 7.28337 17.8178 8.23277 18.7672C9.18217 19.7166 10.4698 20.25 11.8125 20.25C11.7562 20.25 11.7 20.2534 11.6438 20.2601H11.988L11.8125 20.25H12.6428V20.2601H41.4821V20.25H42.1909L42.0187 20.2601H42.363L42.1875 20.25H42.1909C43.5335 20.25 44.8212 19.7166 45.7706 18.7672C46.72 17.8178 47.2534 16.5302 47.2534 15.1875V6.75C47.2534 5.85489 46.8978 4.99645 46.2649 4.36351C45.6319 3.73058 44.7735 3.375 43.8784 3.375H10.125ZM10.1284 23.6351C10.1311 25.4236 10.8434 27.1379 12.109 28.4016C13.3746 29.6652 15.0899 30.375 16.8784 30.375H37.1284C38.9168 30.375 40.6322 29.6652 41.8978 28.4016C43.1633 27.1379 43.8757 25.4236 43.8784 23.6351H10.1284ZM16.8851 48.9375V33.75H37.1318V36.2475C37.1335 37.0971 36.9215 37.9335 36.5151 38.6796C36.1087 39.4257 35.5211 40.0575 34.8064 40.5169L19.4839 50.3584C19.2289 50.522 18.9345 50.6139 18.6318 50.6245C18.329 50.6351 18.0289 50.564 17.7631 50.4187C17.4973 50.2734 17.2755 50.0591 17.121 49.7985C16.9665 49.5379 16.885 49.2405 16.8851 48.9375Z" fill="white"/>
            </svg>
          </div>
