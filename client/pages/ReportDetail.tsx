...
export default function ReportDetail() {
  ...
  return (
    <div className="w-full h-screen bg-[#EEF1FA] overflow-auto">
      {/* Top Navigation Bar */}
      <div className="flex w-full px-6 lg:px-14 py-6 lg:py-14 justify-between items-center min-h-[120px]">
        <div className="flex items-center gap-4 lg:gap-9">
          ...
          <div className="text-[#3D526C] text-xl lg:text-2xl font-semibold">查看报告</div>
        </div>
        ...
        <div className="flex items-center gap-4 lg:gap-9">
          ...
          <button className="flex h-10 lg:h-12 px-3 lg:px-4 py-2 justify-center items-center gap-2 rounded-2xl bg-[#004DA9] hover:bg-[#003d8c] transition-colors">
            ...
            <div className="hidden sm:block text-white text-base lg:text-lg font-semibold">下载报告</div>
          </button>
        </div>
      </div>

      {/* Main Content Container */}
      <div className="flex justify-center px-6 lg:px-14 pb-6 lg:pb-14">
        <div className="w-full max-w-[1328px] h-[768px] bg-white rounded-3xl relative overflow-hidden">
          ...
          <div className="absolute left-0 top-0 w-full h-[375px]">
            <div className="flex w-full max-w-[1232px] mx-auto justify-center items-end gap-16 px-12 pt-8 h-[241px]">
              ...
              <div className="flex-1 text-[#3D526C] text-base leading-8">
                心理沙盘游戏治疗，又称箱庭疗法或沙箱疗法，是一种以荣格心理学原理为基础，由多拉卡尔夫·发展创立的心理治疗方法。沙盘游戏是运用意象(积极想象)进行治疗的创造形式，沙盘中所表现的系列沙盘意象，营造 出沙盘游戏者心灵深处意识和无意识之间的持续性对话，以及由此而激发的治愈过程和人格(灵性与自性化的)发展。
                <br /><br />
          ...
          <div className="absolute left-12 top-[368px] w-[1232px] h-[514px] flex flex-col gap-16">
          ...
          {/* Side Widgets */}
          <div className="absolute right-6 top-[664px] w-24 flex flex-col gap-6">
            {/* Highlight Tool */}
          ...
          {/* Note Input Area */}
          <div className="absolute right-[176px] top-[486px] w-[260px] border-t-[6px] border-[#FEC619] bg-[#FCF3D6] p-6 pb-4">
            <textarea
              value={noteContent}
