...
const mockRecordingData: RecordingEntry[] = [
  {
    id: "1",
    time: "00:00",
    type: "沙具",
  ...
  },
  {
    ...
    type: "语音",
    description:
      "受试者： 对话内容转文字 对话内容转文字 对话内容转文字 对话内容转文字 对话内容转文字",
  },
  {
    id: "5",
    time: "00:00",
    type: "笔记",
    description:
      "笔记内容文本，笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本",
    noteContent: {
      thumbnails: ["thumbnail1", "thumbnail2"],
      text: "笔记内容文本，笔记内容文本笔记内容文本笔记内容文本笔记内容文��笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本",
    },
  },
];
...
export default function RecordingReview() {
  ...
  const filteredData = mockRecordingData.filter(
    (entry) => selectedFilters[entry.type],
  );
  ...
  const renderTableRow = (entry: RecordingEntry) => (
    <div key={entry.id} className="flex flex-col">
        ...
        <div className="w-[400px] flex-shrink-0">
          {entry.type === "笔记" && entry.noteContent ? (
            <div className="flex flex-col justify-center items-start gap-3">
              ...
              <div className="text-[#909399] font-['HONOR_Sans_CN'] text-base font-normal leading-7 w-[400px]">
                {entry.noteContent.text}
              </div>
            </div>
          ) : (
            <div className="text-[#909399] font-['HONOR_Sans_CN'] text-base font-normal leading-7 whitespace-pre-line w-[400px]">
              {entry.description}
            </div>
          )}
        </div>
        <div className="flex px-6 py-0 items-center gap-4">
          <div className="flex w-9 h-9 p-[5px] justify-center items-center rounded-[18px] bg-[#EEF1FA] cursor-pointer hover:bg-[#A8BDE8] transition-colors">
            <svg
      ...
      {/* Separator line */}
      <div className="w-full h-[1px] bg-[#E2E7F0] my-1"></div>
    </div>
  );
  ...
  return (
    <div className="w-full h-screen bg-[#EEF1FA] flex flex-col">
      {/* Top Navigation Bar */}
      <div className="flex w-full px-14 py-14 justify-between items-center">
        <div className="flex items-center gap-9">
          <div className="flex items-center gap-4">
            <button
              onClick={() => navigate("/data-center")}
              className="flex h-12 px-4 py-2 justify-center items-center gap-2 rounded-2xl border border-[#CB2F2F] hover:bg-[#F7E0E0] transition-colors"
            >
              ...
              <div className="text-[#CB2F2F] text-lg font-semibold">退出</div>
            </button>
          </div>
          <div className="w-[1px] h-6 bg-[#B6C2DA]"></div>
          <div className="text-[#3D526C] text-2xl font-semibold">录像检查</div>
        </div>

        <div className="flex items-center gap-9">
          <div className="flex items-center gap-4">
            <div className="text-[#324459] text-base font-normal">显示</div>
            <div className="flex items-center gap-[6px]">
              {Object.entries(selectedFilters).map(([filter, isActive]) => (
                <button
                  key={filter}
                  onClick={() =>
                    handleFilterToggle(filter as keyof typeof selectedFilters)
                  }
        ...
        <div className="flex flex-col w-[468px] gap-4">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex self-stretch aspect-[209/117] rounded-2xl overflow-hidden relative">
              <img
                src="https://cdn.builder.io/api/v1/image/assets%2F633abf5e59cd4a2c979cb3a5ea2346f6%2Fb85b643a90204935ad85f555b5615c7b?format=webp&width=800"
                alt="沙盘成品1"
