...
const mockRecordingData: RecordingEntry[] = [
  ...
  },
  {
    ...
    time: '00:00',
    type: '语音',
    description: '受试者： 对话内容转文字 对话内容转文字 对话内容转文字 对话内容转文��� 对话内容转文字\n咨询师： 对话内容转文字 对话内容转文字 对话内容转文字 对话内容转文字 对话内容转文字'
  },
  {
    id: '4',
    time: '00:00',
...
export default function RecordingReview() {
  ...
  const filteredData = mockRecordingData.filter(entry => 
  ...
  const renderTableRow = (entry: RecordingEntry) => (
    <div key={entry.id} className="flex flex-col">
      <div className="flex px-3 py-2 items-center gap-6 min-h-[44px]">
        <div className="w-20 text-[#324459] font-['HONOR_Sans_CN'] text-base font-normal">
          {entry.time}
        </div>
        <div className="w-20 text-[#324459] font-['HONOR_Sans_CN'] text-base font-normal">
          {entry.type}
        ...
        <div className="flex-1">
          {entry.type === '笔记' && entry.noteContent ? (
            <div className="flex flex-col justify-center items-start gap-3">
              ...
              <div className="text-[#909399] font-['HONOR_Sans_CN'] text-base font-normal leading-7">
        ...
        <div className="w-[295px] flex justify-center items-center gap-4">
        ...
        <div className="flex items-center gap-9">
          ...
          <div className="flex items-center gap-4">
            ...
            <button className="flex h-12 px-4 py-2 justify-center items-center gap-2 rounded-2xl bg-[#004DA9] hover:bg-[#003A87] transition-colors">
              ...
              <div className="text-white text-lg font-semibold">生成报告</div>
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-1 gap-6 px-14 pb-14 overflow-hidden">
        ...
        <div className="flex flex-col w-[468px] gap-4">
          ...
          <div className="flex flex-col items-start gap-4">
            ...
            <div className="flex self-stretch aspect-[209/117] rounded-2xl overflow-hidden">
              <img
                src="https://cdn.builder.io/api/v1/image/assets%2F633abf5e59cd4a2c979cb3a5ea2346f6%2F1fc3586a52f94a41a963174eb74f447b?format=webp&width=800"
                alt="沙盘成品1"
            ...
            <div className="flex self-stretch aspect-[209/117] rounded-2xl overflow-hidden">
              <img
                src="https://cdn.builder.io/api/v1/image/assets%2F633abf5e59cd4a2c979cb3a5ea2346f6%2Fcfa0f266d2e5421b98f7f8b3ff3971ca?format=webp&width=800"
                alt="沙盘成品2"
                className="w-full h-full object-cover"
              />
            </div>
