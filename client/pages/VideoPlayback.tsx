        ...
        >
          ...
          >
            <path
              ...
              fill={currentControl?.buttonDisabled ? "#C7C9CC" : "#004DA9"}
            />
          </svg>
        </button>
      </div>
      ...
      <div className="flex justify-between items-center w-full h-12 mb-6">
        ...
        >
          ...
          >
            {isDownloading ? (
              <path
                d="M12 7.33696C12.3373 7.33696 12.6608 7.20297 12.8993 6.96447C13.1378 6.72598 13.2717 6.4025 13.2717 6.06522V3.52174C13.2717 3.18445 13.1378 2.86098 12.8993 2.62248C12.6608 2.38399 12.3373 2.25 12 2.25C11.6627 2.25 11.3392 2.38399 11.1007 2.62248C10.8622 2.86098 10.7283 3.18445 10.7283 3.52174V6.06522C10.7283 6.4025 10.8622 6.72598 11.1007 6.96447C11.3392 7.20297 11.6627 7.33696 12 7.33696Z"
                fill="white"
              />
            ) : (
              <path
        ...
        <div className="absolute left-0 top-0 w-[306px] h-full bg-black/30 p-6 flex flex-col gap-4">
          <div className="flex justify-between items-center">
            <div className="flex items-center gap-2">
              ...
              >
                <path
                  d="M10.1667 18.5625C9.90694 18.5625 9.68939 18.4725 9.514 18.2925C9.33861 18.1125 9.25061 17.89 9.25 17.625C9.24939 17.36 9.33739 17.1375 9.514 16.9575C9.69061 16.7775 9.90817 16.6875 10.1667 16.6875H19.3333C19.5931 16.6875 19.8109 16.7775 19.9869 16.9575C20.1629 17.1375 20.2506 17.36 20.25 17.625C20.2494 17.89 20.1614 18.1128 19.986 18.2934C19.8106 18.474 19.5931 18.5637 19.3333 18.5625H10.1667Z"
                  fill="white"
                />
              </svg>
            ...
            >
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M10.4515 3.29837C10.9079 3.7548 10.9079 4.49481 10.4515 4.95124L4.40291 10.9998L10.4515 17.0484C10.9079 17.5048 10.9079 18.2448 10.4515 18.7012C9.99505 19.1577 9.25504 19.1577 8.79862 18.7012L1.92362 11.8262C1.46719 11.3698 1.46719 10.6298 1.92362 10.1734L8.79862 3.29837C9.25504 2.84195 9.99505 2.84195 10.4515 3.29837Z"
                fill="white"
              />
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M20.0765 3.29837C20.5329 3.7548 20.5329 4.49481 20.0765 4.95124L14.0279 10.9998L20.0765 17.0484C20.5329 17.5048 20.5329 18.2448 20.0765 18.7012C19.6201 19.1577 18.88 19.1577 18.4236 18.7012L11.5486 11.8262C11.0922 11.3698 11.0922 10.6298 11.5486 10.1734L18.4236 3.29837C18.88 2.84195 19.6201 2.84195 20.0765 3.29837Z"
                fill="white"
              />
            </svg>
          </div>
