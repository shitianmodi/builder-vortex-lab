...
export default function DataCenter() {
  ...
  const timeOptions = ["2025年7月", "2025年6月", "2025年5月", "2025年4月"];

  const sortOptions = ["时间最近", "时间最远", "姓名A-Z", "姓名Z-A"];
  ...
  const renderTag = (tag: string) => {
    ...
    return (
      <div
        className={`flex px-3 py-1 justify-center items-center rounded-xl text-sm font-normal ${tagStyles[tag as keyof typeof tagStyles]}`}
      >
        {tag}
      </div>
    );
  ...
  const renderThumbnail = (type: "video" | "photo") => {
    ...
    return (
      <div className="w-[185px] h-[104px] rounded-lg overflow-hidden relative flex-shrink-0">
        ...
        {type === "photo" && (
          <svg
            className="absolute top-2 left-2 w-5 h-4"
            viewBox="0 0 20 16"
            fill="none"
          >
            <path
  ...
  const renderHistoryCard = (record: HistoryRecord) => {
    ...
    return (
      <div
        key={record.id}
        className="flex w-full max-w-[544px] p-6 flex-col justify-center items-start gap-4 rounded-3xl bg-white"
      >
              ...
              >
                {isSelected && (
                  <svg className="w-3 h-3" viewBox="0 0 12 9" fill="none">
                    <path
                      d="M1.06079 4.22L3.73746 6.71667L10.9375 1"
                      stroke="white"
                      strokeWidth="2"
                      strokeLinecap="round"
          ...
          <div className="flex h-[104px] flex-col items-start gap-3 flex-1">
            <div className="flex w-full h-[46px] px-4 py-2 justify-center items-center gap-2 rounded-2xl border border-[#E2E7F0]">
              <div className="flex items-center gap-1 flex-1">
                ...
                <div className="text-[#606266] text-sm font-normal">
                  沙盘日志
                </div>
              </div>
                ...
                >
                  ...
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M10.5464 3.85314C10.1586 4.25432 10.1586 4.90477 10.5464 5.30596L15.0577 9.97286H4.54546C3.99701 9.97286 3.55241 10.4328 3.55241 11.0002C3.55241 11.5675 3.99701 12.0275 4.54546 12.0275H15.0577L10.5464 16.6944C10.1586 17.0956 10.1586 17.746 10.5464 18.1472C10.9342 18.5484 11.563 18.5484 11.9508 18.1472L18.1574 11.7266C18.5452 11.3254 18.5452 10.6749 18.1574 10.2738L11.9508 3.85314C11.563 3.45195 10.9342 3.45195 10.5464 3.85314Z"
                      fill="white"
                    />
                  </svg>
                </button>
      ...
      <div className="flex w-[116px] h-full p-4 flex-col justify-between items-center bg-[#004DA9] rounded-3xl ml-14 my-14">
        <div className="flex flex-col items-start gap-4 self-stretch">
          ...
          >
            ...
            <div className="self-stretch text-[#A8BDE8] text-center text-sm font-normal">
              主页
            </div>
          </div>
          ...
          <div className="flex w-[84px] h-[84px] p-2 flex-col justify-center items-center gap-1 rounded-2xl bg-[#024089]">
            <svg className="w-12 h-12" viewBox="0 0 48 48" fill="none">
              <path
                d="M39 34.4444V15.5556C39 11.4604 32.1319 8 24 8C15.8681 8 9 11.4604 9 15.5556V34.4444C9 38.5396 15.8681 42 24 42C32.1319 42 39 38.5396 39 34.4444ZM24 11.7778C30.9206 11.7778 35.1206 14.6243 35.25 15.5442C35.1206 16.4868 30.9206 19.3333 24 19.3333C17.0794 19.3333 12.8794 16.4868 12.75 15.5669C12.8794 14.6243 17.0794 11.7778 24 11.7778ZM12.75 20.4799C15.5231 22.0798 19.5694 23.1111 24 23.1111C28.4306 23.1111 32.4769 22.0798 35.25 20.4799V24.9887C35.1206 25.9312 30.9206 28.7778 24 28.7778C17.0794 28.7778 12.8794 25.9312 12.75 25V20.4799ZM12.75 34.4444V29.9243C15.5231 31.5242 19.5694 32.5556 24 32.5556C28.4306 32.5556 32.4769 31.5242 35.25 29.9243V34.4331C35.1206 35.3757 30.9206 38.2222 24 38.2222C17.0794 38.2222 12.8794 35.3757 12.75 34.4444Z"
                fill="white"
              />
            </svg>
            <div className="self-stretch text-white text-center text-sm font-normal">
              数据中心
            </div>
          </div>
      ...
      <div className="flex-1 px-14 py-14 overflow-hidden">
        ...
        <div className="flex items-center gap-6 mb-16">
          <div className="flex flex-col">
            <h1 className="text-[#3D526C] text-[28px] font-semibold">
              数据中心
            </h1>
          </div>
          ...
          <div className="fixed bottom-8 left-1/2 transform -translate-x-1/2 flex w-full max-w-[1204px] mx-4 p-3 justify-between items-center rounded-3xl bg-white shadow-[0_0_20px_7px_rgba(126,144,176,0.20)] z-50">
            <div className="flex items-center gap-6">
              ...
              <div className="text-[#303133] text-base font-normal">
                已选择{" "}
                <span className="text-[#CB2F2F] font-semibold">
