...
export default function LogViewer() {
  ...
  const mockLogs: LogEntry[] = [
    ...
    },
    {
      ...
      type: "笔记",
      description:
        "笔记内容文本，笔记内容文本笔记内容文本笔记内容文本��记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本笔记内容文本",
  ...
  return (
    <div className="w-full h-screen bg-[#EEF1FA] overflow-hidden">
      ...
      <div className="flex gap-6 px-14">
        ...
        <div className="flex-1 bg-white rounded-3xl p-6">
          ...
          <div className="flex items-center gap-6 px-5 py-2 rounded-full bg-[#EEF1FA] mb-4">
            <div className="w-20 text-[#7E90B0] text-base font-semibold">
              时间
            </div>
            <div className="w-20 text-[#7E90B0] text-base font-semibold">
              类型
            </div>
            <div className="w-96 text-[#7E90B0] text-base font-semibold">
              描述
            </div>
            <div className="flex-1 text-[#7E90B0] text-base font-semibold text-center">
              操作
            </div>
          </div>
            ...
            {filteredLogs.map((log, index) => (
              <div key={log.id}>
                <div className="flex items-center gap-6 px-3 py-2">
                  <div className="w-20 text-[#324459] text-base">
                    {log.time}
                  </div>
                  <div className="w-20 text-[#324459] text-base">
                    {log.type}
      ...
      <div className="fixed bottom-6 right-[484px] w-[468px] bg-white rounded-3xl p-3 flex items-center gap-4 shadow-lg">
        <div className="flex flex-col gap-3 flex-1">
          ...
          <div className="relative h-2 bg-[#F4F4F5] rounded-full">
            <div
              className="absolute left-0 top-0 h-2 bg-[#FEC619] rounded-full"
              style={{ width: "55%" }}
            ></div>
          </div>
        </div>
      ...
      <ConfirmationModals
        ...
        logTime={
          mockLogs.find((log) => log.id === showDeleteModal)?.time || "00:00"
        }
      />
