...
const mockTools: ToolItem[] = [
  ...
  },
  {
    ...
    subCategory: "子类型名称",
    image:
      "https://cdn.builder.io/api/v1/image/assets%2F633abf5e59cd4a2c979cb3a5ea2346f6%2F7fabbd312612410484e8edfa284b74c8?format=webp&width=800",
  },
  {
    id: "12",
    name: "沙具名称一行字",
...
export default function ToolManagement() {
  ...
  const [filterType, setFilterType] = useState<"category" | "color">(
    "category",
  );
      ...
      <div className="flex-1 flex flex-col">
                    ...
                    <div key={index}>
                      ...
                      >
                        <div className="flex px-1 items-center gap-2">
                          ...
                          <div className="text-[#324459] text-base">
                            {category.name}
                          </div>
                        </div>
                        <div className="text-[#7E90B0] text-base">
                          {category.count}
                        </div>
                      </div>
                      {category.expanded && category.subCategories && (
                        <div className="flex flex-col gap-1 ml-8">
                          {category.subCategories.map((sub, subIndex) => (
                            <div
                              key={subIndex}
                              className="flex px-4 py-3 justify-between items-center rounded-2xl"
                            >
                              <div className="text-[#324459] text-base">
                                {sub.name}
                              </div>
                ...
                >
                  ...
                  <div className="flex flex-col justify-between items-start flex-1 h-16">
                    ...
                    <div className="flex justify-between items-center w-full">
                      <div className="text-[#303133] text-base">
                        {tool.name}
                      </div>
                      <div className="flex items-center gap-2">
                        <div
                        ...
                        />
                        <div className="text-[#909399] text-base">
                          {tool.colorName}
                        </div>
                      </div>
                    </div>
        ...
        {selectedItems.length > 0 && (
          <div className="fixed bottom-8 left-[204px] w-[1204px] h-[72px] flex px-6 py-3 justify-between items-center rounded-3xl bg-white shadow-[0_0_20px_7px_rgba(126,144,176,0.2)]">
            <div className="text-base">
              ...
              <span className="text-[#CB2F2F] font-bold">
        ...
        {showToolDetail && selectedTool && (
          <div className="fixed inset-0 bg-black bg-opacity-50 z-50">
            <div className="absolute inset-0" onClick={handleCloseToolDetail} />
                  ...
                  <div className="flex justify-end items-start gap-9">
                    ...
                    <div className="flex flex-col gap-6 min-w-[400px]">
                      ...
                      <div className="flex justify-between items-center">
                        <h2 className="text-[#303133] text-2xl font-semibold">
                          {selectedTool.name}
                        </h2>
                        <button
                          onClick={() =>
                            navigate(`/edit-tool/${selectedTool.id}`)
                          }
                          className="flex h-12 px-4 py-2 justify-center items-center gap-2 rounded-2xl border border-[#004DA9] hover:bg-[#f0f4ff] transition-colors"
                        >
                          <svg
                            className="w-6 h-6"
                            viewBox="0 0 24 24"
                      ...
                      <div className="flex flex-col gap-4">
                        ...
                        <div className="flex h-7 items-center gap-6">
                          <div className="w-16 text-[#7E90B0] text-base">
                            分类
                          </div>
                          <div className="flex justify-end items-center gap-1">
                            <span className="text-[#303133] text-base">
