...
export default function Dashboard() {
  ...
  return (
    <div className="min-h-screen w-full bg-gray-100">
      {/* Navigation Sidebar */}
      <div className="fixed left-14 top-14 w-32 h-96 bg-blue-700 rounded-3xl flex flex-col justify-between items-center py-4 px-4 pb-6">
        {/* Navigation Items */}
        <div className="flex flex-col gap-4 w-full">
          ...
          >
            ...
            <span
              className={`text-sm ${selectedNav === "home" ? "text-white" : "text-blue-300"}`}
            >
              主页
            </span>
          </div>
          ...
          <div className="lg:col-span-2 bg-white rounded-3xl p-8">
            ...
            <div className="flex gap-16">
              ...
              <div className="flex-1 space-y-8">
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div
                      ...
                      onClick={() =>
                        setVideoOptions({ ...videoOptions, content: "sandbox" })
                      }
                    >
                      <span
                    ...
                    <div
                      ...
                      onClick={() =>
                        setVideoOptions({ ...videoOptions, content: "both" })
                      }
                    >
                      <span
                        className={`text-base ${
                ...
                <div>
                  <label
                    className="block text-base mb-4"
                    style={{ color: "var(--text-g2)" }}
                  >
                    沙盘类型
                  </label>
                  <div className="space-y-4">
                    <div
                      ...
                      onClick={() =>
                        setVideoOptions({ ...videoOptions, sandType: "wet" })
                      }
                    >
                      <span
                        className={`text-base font-semibold ${
                    ...
                    <div
                      ...
                      onClick={() =>
                        setVideoOptions({ ...videoOptions, sandType: "dry" })
                      }
                    >
                      <span
                        className={`text-base ${
                ...
                <div className="flex items-center gap-1 cursor-pointer">
                  ...
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M8.39893 2.39886C8.06699 2.73081 8.06699 3.269 8.39893 3.60094L12.7979 7.9999L8.39893 12.3989C8.06699 12.7308 8.06699 13.269 8.39893 13.6009C8.73088 13.9329 9.26907 13.9329 9.60102 13.6009L14.601 8.60094C14.933 8.269 14.933 7.73081 14.601 7.39886L9.60102 2.39886C9.26907 2.06692 8.73088 2.06692 8.39893 2.39886Z"
                      fill="#3D526C"
                    />
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
                      d="M1.39893 2.39886C1.06699 2.73081 1.06699 3.269 1.39893 3.60094L5.79789 7.9999L1.39893 12.3989C1.06699 12.7308 1.06699 13.269 1.39893 13.6009C1.73088 13.9329 2.26907 13.9329 2.60102 13.6009L7.60102 8.60094C7.93296 8.269 7.93296 7.73081 7.60102 7.39886L2.60102 2.39886C2.26907 2.06692 1.73088 2.06692 1.39893 2.39886Z"
                      fill="#3D526C"
                    />
                  </svg>
                </div>
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex gap-3">
                      ...
                      <div
                        className="flex items-center gap-0.5 px-2 py-1 rounded-xl"
